...
<script charset="UTF-8" type="text/javascript"  src="{{URL(env('APP_ENDPOINT_FACTORY'))}}/api/modules/formcom?api_key={{ $users->api_key_factory }}&website={{ $websites }}&user_id={{ $forums->user_id }}&software_id={{ $forums->software_id }}"></script>
