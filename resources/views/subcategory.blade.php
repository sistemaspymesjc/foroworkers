...
{{-- <title>{{ 'Premium'.' - '.$categorys[0]['maincategory_name'] }}</title> --}}
	...
	<div class="container">
		...
		<div>
			...
			<div class="bg-info text-center">
				<p>No hay temas publicados premium de negocios {{$mmaincategorys->maincategory_name}}</p>
			</div>
			...
			<p class="lead">Me Ofrezco, Se Solicita, Compra, Venta, Intercambio de {{$categorys[0]['maincategory_name']}} Premium</p>
...
@if(Auth::user()->statu_id == 1 && Auth::user()->is_buyer == 1 && Auth::user()->is_verified == 1 && Auth::user()->is_banned == 0)
